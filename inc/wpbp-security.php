...
function wpbp_force_https() {
    if ( isset($_SERVER['HTTP_HOST']) && ! is_ssl() && wpbp_get_option( 'force_https' ) === 'yes' ) {
...
function wpbp_login_notification( $user_login, $user ) {
...
add_action( 'wp_login', 'wpbp_login_notification', 10, 2 );
