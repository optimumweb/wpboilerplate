...
<div class="form-wrap">
	...
	<?php
		foreach ( $wpbp_meta_box_fields as $wpbp_meta_box_field_key => $wpbp_meta_box_field_args ) :
			...
			$wpbp_meta_box_field_value_name = WPBP_META_BOX_PREFIX . $wpbp_meta_box_field_value_key;
	...
	<div class="form-field form-required">
		...
		<input id="<?php echo $wpbp_meta_box_field_id; ?>" type="text" name="<?php echo $wpbp_meta_box_field_value_name; ?>" value="<?php echo $wpbp_meta_box_field_value; ?>" />
...
function wpbp_save_meta( $post_id )
{
	...
	foreach ( $wpbp_meta_boxes as $wpbp_meta_box ) {
		...
		foreach ( $wpbp_meta_box_fields as $wpbp_meta_box_field_key => $wpbp_meta_box_field_args ) {
			...
			$wpbp_meta_box_field_value_new = $_POST[$wpbp_meta_box_field_value_name];
