(function( $ ) {
	$.fn.powerslide = function() {
		return this.each(function() {
			...
			var $play = $powerslide.find('.play').length ? $powerslide.find('.play') : $powerslide.append('<a href="#" class="play hidden"></a>').find('.play');
			var $pause = $powerslide.find('.pause').length ? $powerslide.find('.pause') : $powerslide.append('<a href="#" class="pause hidden"></a>').find('.pause');
			
			var $prev = $powerslide.find('.prev').length ? $powerslide.find('.prev') : $powerslide.append('<a href="#" class="prev hidden"></a>').find('.prev');
			var $next = $powerslide.find('.next').length ? $powerslide.find('.next') : $powerslide.append('<a href="#" class="next hidden"></a>').find('.next');
